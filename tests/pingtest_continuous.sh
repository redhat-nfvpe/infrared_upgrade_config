...
ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${LOGIN_USER}@${LAST_FIP_1} ping 10.0.10.3 &> /tmp/pingtest1_output &
ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${LOGIN_USER}@${LAST_FIP_2} ping 10.0.10.2 &> /tmp/pingtest2_output &
