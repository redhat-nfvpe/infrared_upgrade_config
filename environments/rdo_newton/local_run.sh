...
infrared tripleo-undercloud -vv -o install.yml \
    ...
    --version newton \
    --config-file ../infrared_upgrade_config/rdo_newton/undercloud.conf
...
infrared tripleo-overcloud -v -o overcloud-install.yml --version newton --deployment-files ../infrared_upgrade_config/rdo_newton --introspect=yes --tagging=yes --deploy=no -e provison_virsh_network_name=br-ctlplane --hybrid ../infrared_upgrade_config/rdo_newton/hybrid_nodes.json

sleep 5

infrared tripleo-overcloud -vv -o overcloud-install.yml --version newton --deployment-files ../infrared_upgrade_config/rdo_newton --overcloud-script ../../../infrared_upgrade_config/rdo_newton/overcloud_deploy.sh --introspect=no --tagging=no --deploy=yes -e provison_virsh_network_name=br-ctlplane --hybrid ../infrared_upgrade_config/rdo_newton/hybrid_nodes.json --ansible-args="skip-tags=inventory_update"
